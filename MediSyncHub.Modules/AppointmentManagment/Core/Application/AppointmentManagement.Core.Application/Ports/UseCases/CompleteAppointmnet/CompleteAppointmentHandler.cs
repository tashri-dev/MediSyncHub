...
public class CompleteAppointmentHandler(
    ...
    : IRequestHandler<CompleteAppointmentCommand, ManipulateAppointmentResult>
{
    public async Task<ManipulateAppointmentResult> Handle(CompleteAppointmentCommand request,
